...
class Dataset(object):
    ...
    def __init__(self, data_dir, fold, shot, input_size=[400, 400] , normalize_mean=[0.485, 0.456, 0.406],
    ...
    def __getitem__(self, index):
        ...
        scale_transform_d = torchvision.transforms.Resize([scaled_size, scaled_size], interpolation=Image.NEAREST)
