...
from model.base.feature import extract_feat_vgg, extract_feat_res, as_extract_feat_res
...
class AttentiveSqueezeNetwork(nn.Module):
    def __init__(self, args, use_original_imgsize):
        ...
        if args.backbone == 'vgg16':
            ...
            self.extract_feats = as_extract_feat_res
